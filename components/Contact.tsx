    ...
    <section id="contact" className="flex items-center justify-center">
      <div className="max-w-4xl mx-auto px-6 text-center">
        <div className="animate-fade-in">
          <p className="text-indigo-400 tracking-widest uppercase text-sm mb-4">Get in Touch</p>
        ...
        {/* Footer */}
        <p className="text-white/30 text-sm mt-20">
          &copy; {new Date().getFullYear()} Portfolio. Built with Next.js & Spline.
        </p>
      </div>
    </section>
  );
